# georgia Development Guidelines
...
- Microsoft Agentic Framework 1.37+ Python (003-emergency-response-agent, 004-policy-compliance-checker, 005-inter-agency-knowledge-hub)
- Microsoft Agentic Framework 1.65.0 .NET (006-dotnet-virtual-citizen-assistant)
...
DotNet-Virtual-Citizen-Assistant/ # 006 - Georgia citizen services RAG chatbot (.NET)
...
- Microsoft Agentic Framework plugins with KernelFunction attributes

## Recent Changes

- 006-dotnet-virtual-citizen-assistant: Added .NET 9, Microsoft Agentic Framework 1.65, RAG pipeline, Azure AI Search, Bootstrap UI
- 005-inter-agency-knowledge-hub: Added Azure AI Search, Entra ID auth, cross-agency search, audit logging
- 004-policy-compliance-checker: Added Microsoft Agentic Framework, pypdf, python-docx, compliance rule engine
- 003-emergency-response-agent: Added Microsoft Agentic Framework, Weather API integration
